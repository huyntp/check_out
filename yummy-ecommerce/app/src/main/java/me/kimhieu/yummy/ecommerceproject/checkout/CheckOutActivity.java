...
import me.kimhieu.yummy.ecommerceproject.explore.PagerViewAdapter;
...
public class CheckOutActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_products_checkout);
    ...
    private void displayCheckoutProduct() {
        ...
        productsResponseCall.enqueue(new Callback<ProductsResponse>() {
            ...
            public void onResponse(Call<ProductsResponse> call, Response<ProductsResponse> response) {
                ...
                recyclerViewAdapter = new CheckOutRecyclerViewActivity(getApplicationContext(),checkoutProductList);
